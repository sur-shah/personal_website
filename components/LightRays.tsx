...
void main() {
  ...
  gl_FragColor  = color;
      ...
      updatePlacement();
      if (reduceMotion) loop(0);
      else animationIdRef.current = requestAnimationFrame(loop);
    ...
    void initializeWebGL().catch((error: unknown) => {
      console.warn('Light Rays could not initialize:', error);
    });
